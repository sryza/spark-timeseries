 ...
 * @since 3.0
 */
public class BOBYQAOptimizerCustom
     ...
     */
    public BOBYQAOptimizerCustom(int numberOfInterpolationPoints) {
     ...
     * @param maxIter Max iter for bobyqa
     */
    public BOBYQAOptimizerCustom(int numberOfInterpolationPoints,
    ...
    private double bobyqb(double[] lowerBound,
        ...
        L100 :switch (state) {
                ...
                case 90: {
                    ...
                    if (ntrits == 0) {
                        state = 210; break L100;
                    }
                    state = 230; break L100;
...
//                 throw new PathIsExploredException(); // XXX
    ...
    private double[] trsbox(
        ...
        throw new MathIllegalStateException(LocalizedFormats.MAX_ITERATIONS_EXCEEDED,(int)maxIter);
    } // trsbox
    ...
    private static class PathIsExploredException extends RuntimeException {
        ...
        PathIsExploredException() {
            super(PATH_IS_EXPLORED + " " + BOBYQAOptimizerCustom.caller(3));
        }
    }
}
