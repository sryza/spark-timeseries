...
import com.cloudera.morlock.DateTimeIndex._
import com.cloudera.morlock.TimeSeriesUtils._
...
object DateTimeIndex {
   ...
   */
  private[morlock] def rebaseDayOfWeek(
      dayOfWeek: Int,
   ...
   */
  private[morlock] def nextBusinessDay(
      dt: ZonedDateTime,
