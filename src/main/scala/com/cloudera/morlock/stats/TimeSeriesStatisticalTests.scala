 ...
 * License.
 */
package com.cloudera.morlock.stats

import breeze.numerics.polyval
import breeze.linalg.{DenseMatrix => BreezeDenseMatrix}
import com.cloudera.morlock.{Lag, MatrixUtil, UnivariateTimeSeries}
import com.cloudera.morlock.MatrixUtil.{toBreeze, fromBreeze}
