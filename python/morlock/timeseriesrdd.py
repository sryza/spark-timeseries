...
class TimeSeriesRDD(RDD):
    ...
    def __init__(self, dt_index, rdd, jtsrdd = None, sc = None):
        if jtsrdd == None:
            ...
            self._jtsrdd = jvm.com.cloudera.morlock.api.java.JavaTimeSeriesRDDFactory.timeSeriesRDD( \
...
def time_series_rdd_from_observations(dt_index, df, ts_col, key_col, val_col):
    ...
    """
    jvm = df._sc._jvm
    jtsrdd = jvm.com.cloudera.morlock.api.java.JavaTimeSeriesRDDFactory.timeSeriesRDDFromObservations( \
