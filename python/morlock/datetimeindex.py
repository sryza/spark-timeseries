...
class DayFrequency(_Frequency):
    ...
    def __init__(self, days, sc):
        self._jfreq = sc._jvm.com.cloudera.morlock.DayFrequency(days)
...
class HourFrequency(_Frequency):
    ...
    def __init__(self, hours, sc):
        self._jfreq = sc._jvm.com.cloudera.morlock.HourFrequency(hours)
...
class BusinessDayFrequency(object):
    ...
    def __init__(self, bdays, sc):
        self._jfreq = sc._jvm.com.cloudera.morlock.BusinessDayFrequency(bdays)
...
def uniform(start, end=None, periods=None, freq=None, sc=None):
    ...
    ----------
        ...
        sc : SparkContext
    """
    dtmodule = sc._jvm.com.cloudera.morlock.__getattr__('DateTimeIndex$').__getattr__('MODULE$')
    if freq is None:
